(function() {
  const myself = {
    ...
    description:
      'Hi, I’m Williams.`\n`  I’m a Software Engineer from Uruguay, an small country near latitude 33.`\n`  I’ve been working the past 12 years in Software Development, being part of multiple`\n`  projects and building a great variety of programs using different techonologies, nowadays working as the CTO of ZirconTech.`\n`  I’m a passionate music listener, loving to travel and having long lectures of Asimov books.',
    getCompetencies:
